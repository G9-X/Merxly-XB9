...
builder.Services.AddCors(options =>
{
    options.AddPolicy("AllowFrontend", policy =>
    {
          policy.WithOrigins(
                ...
                "http://localhost:7052", 
                "https://merxly.vercel.app", 
                "http://xbrain-alb-us-dev-122585504.us-west-2.elb.amazonaws.com", 
                "https://app.group9.id.vn", 
                "https://group9.id.vn", 
                "https://d2ow4xvug19ymv.cloudfront.net",
                "https://d1q4dgcsrlyc0r.cloudfront.net",
                "https://d20a0kllwtgjf8.cloudfront.net",
                "http://xbrain-static-i46zjt.s3-website-us-east-1.amazonaws.com"
              )
              .AllowAnyHeader()
              .AllowAnyMethod()
              .AllowCredentials();
