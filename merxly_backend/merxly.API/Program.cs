...
builder.Services.AddCors(options =>
{
    ...
    {
          policy.WithOrigins("http://localhost:5173", "https://localhost:5173", "http://localhost", "http://localhost:7052", "https://merxly.vercel.app", "http://xbrain-alb-us-dev-122585504.us-west-2.elb.amazonaws.com", "https://d1q4dgcsrlyc0r.cloudfront.net", "https://app.group9.id.vn", "https://group9.id.vn", "https://dnws0mm9hulls.cloudfront.net")
              .AllowAnyHeader()
              .AllowAnyMethod()
              .AllowCredentials();
    });
